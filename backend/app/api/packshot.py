"""Endpoint : ajoute un packshot en fin d'une video existante SANS recompresser
le film (concat -c copy). ASYNCHRONE (comme /assemble) : le film peut peser
plusieurs Go -> on rend un job_id immediatement et le travail (download +
concat + upload B2 streaming) tourne en tache de fond. Le statut se suit via
GET /jobs/{id}/status."""
